...
export const defaultPlans = [
  {
    ...
    exercises: [
      ...
      { exerciseId: 'plank', defaultSets: 3, defaultReps: 1 },
    ],
  },
  {
    id: 'full-body-b',
